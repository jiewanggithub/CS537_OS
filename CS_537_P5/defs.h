...
// sys_mmap.c
void            *my_mmap(int, struct file *, int, int, int, int); 
int             my_munmap(struct proc *, int, int);
int             copy_maps(struct proc *, struct proc *);
int             mmap_store_data(struct proc *, int, int, int, int, struct file *, int); 
uint            get_physical_page(struct proc *, uint, pte_t **); 
